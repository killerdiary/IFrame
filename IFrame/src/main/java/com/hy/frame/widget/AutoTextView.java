...
public class AutoTextView extends TextView implements IAutoDesign {
    ...
    private void initAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.designScreenWidth = a.getInt(R.styleable.AutoTextView_designScreenWidth, 0);
    ...
    public float calDesignScale() {
        return ResUtil.calDesignScale(getContext(), getDesignScreenWidth());
    }

    @Override
    public int calDesignWidth(int width) {
        return ResUtil.calDesignWidth(width, getDesignScale());
    }
}
